...
<script type="text/javascript">
    ...
    function sure () {  //确认退出登录的提示框
        ...
        if(confirm("确认退出？"))
        {
            window.location.href="admin_login.action";
        }
...
<div class="center-block" style="text-align: center;padding-top:60px ;">
    <button type="button" class="btn btn-danger button01" onclick="window.location.href='/book/queryBookOfAdmin'">书籍管理</button>

    <button type="button" class="btn btn-primary button01" onclick="window.location.href='/order/queryOrder'">订单管理</button>

    <button type="button" class="btn btn-danger button01" onclick="window.location.href='/booksort/queryBooksort'">分类管理
    </button>
