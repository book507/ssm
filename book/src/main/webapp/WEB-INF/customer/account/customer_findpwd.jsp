...
<form action="/customer/findPass" method="post" class="basic-grey"  onsubmit="return formCheck()">
        <h1 align="center">找回密码
        </h1>
        <p align="center">
        ...
        <p align="center">
            ...
            <input  type="text" name="cSfz" placeholder="请输入身份证号码" required="required"/>
        </p>

        <p align="center">

            <input id="cPwd" type="password" name="cPwd" placeholder="请输入新的密码" required="required"/>
        </p>
        <p align="center">

            <input id="recPwd" type="password" name="recPwd" placeholder="请确认新的密码" required="required"/>
        </p>
