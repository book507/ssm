...
import com.goldenhouse.mapper.CartMapper;
...
public class CartDaoImpl implements ICartDao {
    ...
    public List<Map> queryBookOfCart(Integer cId) {
        return cartMapper.queryBookOfCart(cId);
    }
    ...
    public int deleteBookOfCart(int gId) {
        return cartMapper.deleteBookOfCart(gId);
    }
    ...
    public List<Integer> queryBIdOfFavorite(int cId) {
        return cartMapper.queryBIdOfFavorite(cId);
    }
    ...
    public int addBookToFavorite(Integer cId, Integer bId) {
        return cartMapper.addBookToFavorite(cId,bId);
    }
    ...
    public int addBookToOrder(Integer cId,Integer bId) {
        return cartMapper.addBookToOrder(cId,bId);
    }
    ...
    public int updateGradeToCus(int cId) {
        return cartMapper.updateGradeToCus(cId);
    }
    ...
    public int deleteBookToCart(int gId) {
        return cartMapper.deleteBookToCart(gId);
    }
    ...
    public Cart queryByCIdByBId(Cart cart) {
        return cartMapper.queryByCIdByBId( cart );
    }
